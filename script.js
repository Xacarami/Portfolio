...
const descricaoHabilidadeEscrito = document.getElementById("descricaoHabilidadeEscrito");
...
if(botaoHtml){
    botaoHtml.addEventListener("click", ()=>{
        ...
        descricaoHabilidadeEscrito.innerHTML = "HTML é uma linguagem de marcação utilizada na construção de páginas na Web. Documentos HTML podem ser interpretados por navegadores.";
    })
}
...
if(botaocss){
    botaocss.addEventListener("click", ()=>{
        ...
        descricaoHabilidadeEscrito.innerHTML = "Cascading Style Sheets é um mecanismo para adicionar estilos a uma página web, aplicado diretamente nas tags HTML ou ficar contido dentro das tags <style>.";
    })
}
...
if(botaojavascript){
    botaojavascript.addEventListener("click", ()=>{
        ...
        descricaoHabilidadeEscrito.innerHTML = "JavaScript é uma linguagem de programação interpretada estruturada, de script em alto nível com tipagem dinâmica fraca e multiparadigma. Juntamente com HTML e CSS, o JavaScript é uma das três principais tecnologias da World Wide Web.";
    })
}
if(botaoreact){
    botaoreact.addEventListener("click", ()=>{
        tituloHabilidade.innerHTML = "React";
        descricaoHabilidadeEscrito.innerHTML = "O React é uma biblioteca front-end JavaScript de código aberto com foco em criar interfaces de usuário em páginas web.";
    })
}
if(botaonodejs){
    botaonodejs.addEventListener("click", ()=>{
        tituloHabilidade.innerHTML = "NodeJs";
        descricaoHabilidadeEscrito.innerHTML = "Node.js é um software de código aberto, multiplataforma, baseado no interpretador V8 do Google e que permite a execução de códigos JavaScript fora de um navegador web. A principal característica do Node.js é sua arquitetura assíncrona e orientada por eventos.";
    })
}
...
if(botaopostgresql){
    botaopostgresql.addEventListener("click", ()=>{
        ...
        descricaoHabilidadeEscrito.innerHTML = "PostgreSQL é um sistema gerenciador de banco de dados objeto relacional, desenvolvido como projeto de código aberto.";
    })
}
